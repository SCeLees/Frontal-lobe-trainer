...
const allGames = [
  ...
  { id: 'dccs',                category: 'cognitive-flex',  icon: '🎨', name: 'DCCS 卡片分类',     description: '先按颜色分类，中段切换为按形状分类',           color: '#8b5cf6' },
  { id: 'schulte-grid',        category: 'attention',       icon: '🎯', name: '舒尔特表',         description: '5×5方格1-25随机排列，30秒内依次点击',         color: '#22c55e' },
